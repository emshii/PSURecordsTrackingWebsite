...
if (isset($_SESSION['offices']) && $_SESSION['offices'] != 'Admin') {
    header('location:ADMINupdatetrack.php');
    die();
}
...
<div class="modal fade" id="updatemodal" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="tracknewAdmin.php" method="POST">
                            ...
                            <div class="container-fluid">
                                <table class="tables table-hover table-striped table-border" style="width: 95%;">
                                    ...
                                    <tbody>
                                        <?php
                                        // bas
                                        $sql = "SELECT * FROM users WHERE channel_1 = 'cs' OR channel_2 = 'cs' OR channel_3 = 'cs' OR channel_4 = 'cs' OR channel_5 = 'cs' OR user_officestarget = 'cs'
                                            OR channel_1 = 'VPRE' OR channel_2 = 'VPRE' OR channel_3 = 'VPRE' OR channel_4 = 'VPRE' OR channel_5 = 'VPRE' OR user_officestarget = 'VPRE'
                                            OR channel_1 = 'CBA' OR channel_2 = 'CBA' OR channel_3 = 'CBA' OR channel_4 = 'CBA' OR channel_5 = 'CBA' OR user_officestarget = 'CBA'
                                            OR channel_1 = 'Budget' OR channel_2 = 'Budget' OR channel_3 = 'Budget' OR channel_4 = 'Budget' OR channel_5 = 'Budget' OR user_officestarget = 'Budget'
                                            OR channel_1 = 'CAH' OR channel_2 = 'CAH' OR channel_3 = 'CAH' OR channel_4 = 'CAH' OR channel_5 = 'CAH' OR user_officestarget = 'CAH'
                                            OR channel_1 = 'Office of the Student Affairs' OR channel_2 = 'Office of the Student Affairs' OR channel_3 = 'Office of the Student Affairs' OR channel_4 = 'Office of the Student Affairs' OR channel_5 = 'Office of the Student Affairs' OR user_officestarget = 'Office of the Student Affairs'
                                            OR channel_1 = 'Records' OR channel_2 = 'Records' OR channel_3 = 'Records' OR channel_4 = 'Records' OR channel_5 = 'Records' OR user_officestarget = 'Records'
                                            OR channel_1 = 'Accounting' OR channel_2 = 'Accounting' OR channel_3 = 'Accounting' OR channel_4 = 'Accounting' OR channel_5 = 'Accounting' OR user_officestarget = 'Accounting'
                                            OR channel_1 = 'VPAA' OR channel_2 = 'VPAA' OR channel_3 = 'VPAA' OR channel_4 = 'VPAA' OR channel_5 = 'VPAA' OR user_officestarget = 'VPAA'
                                            OR channel_1 = 'VPFA' OR channel_2 = 'VPFA' OR channel_3 = 'VPFA' OR channel_4 = 'VPFA' OR channel_5 = 'VPFA' OR user_officestarget = 'VPFA'
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['channel_1']  ?></td>
                                                <td><?php echo $row['channel_2']  ?></td>
                                                <td><?php echo $row['channel_3']  ?></td>
