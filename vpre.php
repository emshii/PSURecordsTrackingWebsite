        ...
        <div class="row justify-content-center">
            <div class="col-12 bg light rounded my-2 py-2">
                <div class="container-fluid">
                    <h5 class="text-center text-dark pt-2"> Welcome to <span class="text-danger"> Office of the Vice-President </span> <br> Tracking Document</h5>
                            ...
                            <div class=" container">
                                <table class=" table table-blocked table-stripped table-hover table-responsive table-xl w-100%" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM track_communication WHERE track_offices = 'VPRE' ";
