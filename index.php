...
<div class="modal fade" id="trackinfoModal" tabindex="1" role="dialog">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="trackresultwithcondition.php" method="POST">
        ...
        <div class="modal-content">
            ...
            <form action="tracknew.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="track_actions" id="office">
                                ...
                                <option value="Recommended for Disapproval">Recommended for disapproval</option>
                            </select>
                        </div>
                    </div>
                    <!-- <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="inputOfficer" class="col-sm-2 col-form-label">Received by</label>
                        <div class="col-sm-10">
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-body container-fluid">
                            <h4 class="text-center text-dark pt-2">Tracking System</h4>
                        ...
                        <div class=" card-footer ">
                            ...
                            <hr>
                            <table class="table table-blocked table-stripped table-hover table-responsive table-xl">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM track_communication";
                                    $result = mysqli_query($conn, $sql);
                                    $count = mysqli_num_rows($result);
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        $timestamp = $row['track_dates'];
                                        $action = $row['track_actions'];
                                        // https://stackoverflow.com/questions/7533312/php-if-statement-to-change-color-of-table-rows-td
                                    ?>
                                        <tr>
                                            ...
                                            <?php if ($action == 'Received') { ?>
                                                ...
                                                <td bgcolor="#FFFF00"><?php echo $row['track_actions'] ?></td>

                                            <?php     } else if ('Forwarded') { ?>
                                                <td bgcolor="399CC66"><?php echo $row['track_actions'] ?></td>
                                            <?php      } else {
                                            } ?>
