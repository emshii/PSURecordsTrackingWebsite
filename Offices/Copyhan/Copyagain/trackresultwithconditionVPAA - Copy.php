        ...
        <center>
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-borderless">
                        ...
                        ?>
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td class="text-center m-1 p-1 mb-1"><?php echo $row['track_dates'] ?></td>
                                            <td class="text-left m-1 p-1 mb-1 "><?php echo $row['track_offices'] ?></td>
                    ...
                    <br>
                    <a href="vpaa.php" class="btn btn-primary"><span class="material-icons">
