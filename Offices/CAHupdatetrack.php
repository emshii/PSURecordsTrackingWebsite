...
<div class="modal fade" id="trackinfoModal" tabindex="1" role="dialog">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="trackresultwithconditionAccounting.php" method="POST">
        ...
        <div class="row justify-content-center">
            <div class="col-12 bg light rounded my-2 py-2">
                <div class="container-fluid">
                    <h5 class="text-center text-dark pt-2"> Welcome to <span class="text-success"> Office of College of Arts & Humanities </span> <br> Tracking Document</h5>
                                    ...
                                    <table class="tables table-hover table-striped table-border" style="width: 70%;">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT users.id, track_communication.track_dates,track_communication.user_trackingid, users.user_name,track_communication.track_remarks, users.user_title,users.user_officestarget,track_communication.track_actions, track_communication.track_offices, users.channel_1, 
                                                ...
                                                INNER JOIN track_communication ON  users.user_trackingid = track_communication.user_trackingid WHERE channel_1 = 'CAH' OR channel_2 = 'CAH' OR channel_3 = 'CAH' OR channel_4 = 'CAH' OR channel_5 = 'CAH' OR user_officestarget = 'CAH'";
