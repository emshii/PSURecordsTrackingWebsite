...
<div class="modal fade" id="updatemodal" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="tracknewVFPA.php" method="POST">
        ...
        <div class="row justify-content-center">
            <div class="col-12 bg light rounded my-2 py-2">
                <div class="container-fluid">
                    <h5 class="text-center text-dark pt-2"> Welcome to <span class="text-success">Office of Vice President Finance Adminstration</span> <br> Tracking Document</h5>
                            ...
                            <div class=" container-fluid">
                                <table class="tables table-hover table-striped table-border" style="width: 70%;">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT users.id,track_communication.user_trackingid, track_communication.track_dates, users.user_name,track_communication.track_remarks, users.user_title,users.user_officestarget,track_communication.track_actions, track_communication.track_offices, users.channel_1, 
                                                users.channel_2,users.channel_3,users.channel_4,users.channel_5 FROM users
                                                INNER JOIN track_communication ON  users.user_trackingid = track_communication.user_trackingid WHERE channel_1 = 'VPFA' OR channel_2 = 'VPFA' OR channel_3 = 'VPFA' OR channel_4 = 'VPFA' OR channel_5 = 'VPFA' OR user_officestarget = 'VPFA'";
