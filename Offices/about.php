    ...
    <div class="container-fluid home-section">
        <div class="container mt-4 text-left">
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body bg-light">
                            ...
                            <p class="card-text  text-dark text-justify"> <small>To continuosly develop and to upgrade the services, programs and objectives of the office towards a sustainable records and Archives Management
            ...
            <div class="card mb-2">
                ...
                <img src="../images/Psubackground.png" class=" card-img-top" alt="...">
            </div>
            <hr>
            <br>
            <div class="container">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item " style="width: 400px">
                                <img src="/images/logo.png" class="d-block w-100" alt="logo.png">
                                <div class="carousel-caption d-none d-md-block">
                                    <!-- <h5>Track System</h5> -->
                            ...
                            <div class="carousel-item">
                                <img src="/images/psu2.png" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-info"> <span class="material-icons">
                            tour
