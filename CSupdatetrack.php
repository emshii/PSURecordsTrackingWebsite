...
<div class="modal fade" id="updatemodal" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="tracknewCollegeScience.php" method="POST">
        ...
        <div class="row justify-content-center">
            <div class="col-12 bg light rounded my-2 py-2">
                <div class="container-fluid">
                    <h5 class="text-center text-dark pt-2"> Welcome to <span class="text-success"> College of Science </span> <br> Tracking Document</h5>
                            ...
                            <div class="container-fluid">
                                ...
                                <table class="tables table-hover table-striped table-border" style="width: 70%;">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT users.id, track_communication.track_dates,users.email,track_communication.user_trackingid, users.user_name,track_communication.track_remarks, users.user_title,users.user_officestarget,track_communication.track_actions, track_communication.track_offices, users.channel_1, 
